  ...
  <RouteContext.Consumer>
    {({ isMobile }) => (
      <Descriptions className={styles.headerList} size="small" column={isMobile ? 1 : 2}>
        <Descriptions.Item label="采集间隔">60 秒</Descriptions.Item>
        <Descriptions.Item label="采集超时">10 秒</Descriptions.Item>
        <Descriptions.Item label="计算间隔"> 60 秒</Descriptions.Item>
        <Descriptions.Item label="额外标签">
          < a href="">region: wh / replica: 0</a>
        </Descriptions.Item>
